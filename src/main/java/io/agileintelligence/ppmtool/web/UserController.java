...
import io.agileintelligence.ppmtool.domain.DuplicatedUser;
...
public class UserController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody User user, BindingResult result){
		...
		try {
			...
			DuplicatedUser duser = new DuplicatedUser();
			duser.setUsername("Username '"+ user.getUsername()+"' already exists");
			return new ResponseEntity<DuplicatedUser>(duser, HttpStatus.BAD_REQUEST);	
		}
